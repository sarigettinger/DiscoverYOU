...
create table dbo.Personalities(
    ...
    ExtrovertScore decimal(4,2) not null constraint c_personalities_ExtrovertScore_cant_be_negitive check(ExtrovertScore >= 0),
    ...
    NumofCounselingSessions int not null constraint c_personalities_NumofCounselingSessions_cant_be_negitive check(NumofCounselingSessions >= 0),
